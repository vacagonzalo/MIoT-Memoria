...
En la esquina inferior izquierda de la figura se pueden observar círculos grises claros y oscuros, estos representan los huecos y electrones generados por el efecto Compton \citep{BOOK:comptom} y fotoeléctrico.
...
\begin{table}[h]
	...
	\begin{tabular}{l c c}    
		...
		\midrule
        \emph{Latch-up}             & SEL               & Pico de corriente\\		
        ...
        \emph{Burnout}              & SEB               & Activación de transistores parásitos\\
        \emph{Gate Rapture}         & SEGR              & Generación de plasma de alta densidad\\
		\bottomrule
		\hline
	\end{tabular}
	\label{tab:radiacion}
...
Diseñar un ensayo dinámico por radiación es un proceso largo y costoso, demanda personal capacitado e instalaciones específicas.
...
Otra técnica disponible son los ensayos basados en \emph{software}, cuyo método se basa en introducir instrucciones espúreas que generen errores.
