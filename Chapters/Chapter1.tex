...
La interacción de una partícula de radiación con el semiconductor genera portadores de carga eléctrica.
Estos portadores se manifiestan como electrones y huecos a lo largo de su trayectoria.
Inmediatamente, son separados por los campos eléctricos internos antes de que se produzca su recombinación.
Esto altera la distribución de carga interna y los campos eléctricos asociados.
En determinadas circunstancias este efecto produce el cambio de un estado lógico dentro del dispositivo.
Ese cambio puede ser permanente y afectar un dato o una configuración interna.
Ese efecto se denomina \emph{soft-error} y es el objeto de estudio de este trabajo.
En la figura \ref{fig:bitflip} se puede observar ese efecto sobre una celda de memoria básica.
